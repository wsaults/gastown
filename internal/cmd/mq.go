...
var mqCmd = &cobra.Command{
	...
	Long: `Manage the merge queue for landing completed work.

The merge queue coordinates merging polecat work branches into target branches.
Merge requests are implemented as beads issues with type "merge-request".

Common operations:
  gt mq list                    Show all pending merge requests
  gt mq list --ready            Show only ready-to-merge
  gt mq status <id>             Detailed view of a merge request`,
}
